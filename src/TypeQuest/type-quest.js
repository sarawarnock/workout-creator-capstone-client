    ...
    render() {
        ...
        return (
            <div className="form-group">
                ...
                <input type="radio" id="emom" name="workoutTypeValue" value={this.props.emom} onClick={this.props.handleTypeChange} />
                <label htmlFor="emom">EMOM (Every Minute On the Minute)</label>
                
                <input type="radio" id="amrap" name="workoutTypeValue" value={this.props.amrap} onClick={this.props.handleTypeChange} />
